...
var() private config localized string StringP;
var() private config localized string StringQ;
...
var() private config localized string CampaignPathBlurb[5];
...
private function StockCareersSelected()
{
    ...
    MyCampaignPathBox.List.Add(StringM, , , 0);	// FRTE Missions
	MyCampaignPathBox.List.Add(StringN, , , 1);	// Extra Missions
    MyCampaignPathBox.List.Add(StringO, , , 2); // All missions
	MyCampaignPathBox.List.Add(StringP, , , 3); // FR Mode
	MyCampaignPathBox.List.Add(StringQ, , , 4); // Original Missions
}
...
defaultproperties
{
	...
	StringL="Mission Set:"
	StringM="FRTE Missions"
	StringN="Extra Missions"
	StringO="All Missions"
	StringQ="Vanilla SWAT4+TSS Missions"
	...
	CampaignPathBlurb[0]="[c=FFFFFF]Uses FRTE settings and campaign of the original SWAT 4 and The Stetchkov Syndicate missions. [b]Some equipment may need to be unlocked.[\\b]"
	...
	CampaignPathBlurb[3]="[c=FFFFFF]A combined campaign of the original SWAT 4 and The Stetchkov Syndicate missions. [b]Limited to only plausible United States SWAT equipment.[\\b]"
	CampaignPathBlurb[4]="[c=FFFFFF]Uses classic settings and combined campaign of the original SWAT 4 and The Stetchkov Syndicate missions. [b]Limited to only Classic game equipment and Part New Added.[\\b]"
