class Do_NeutralizeVIPEnemies extends SwatGame.Objective_Do
    implements IInterested_GameEvent_GameStarted, IInterested_GameEvent_PawnDied, IInterested_GameEvent_PawnIncapacitated;
