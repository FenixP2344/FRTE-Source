...
AUTOGENERATE_NAME(GetNoDropWeaponChance)
...
AUTOGENERATE_NAME(IsInFormation)
...
AUTOGENERATE_NAME(SwapInRestrainedFloorAnimSet)
AUTOGENERATE_NAME(ThreatTimerIsOver)
...
// "event"	function whose parameters correspond to	"struct IISwatAI_eventSwapInRestrainedFloorAnimSet_Parms"	is declared	in "..\SwatAICommon\Classes\ISwatAI.uc"
struct IISwatAI_SwapInRestrainedFloorAnimSet_Parms
{
};
...
// "event"	function whose parameters correspond to	"struct IISwatEnemy_eventGetNoDropWeaponChance_Parms"	is declared	in "..\SwatAICommon\Classes\ISwatEnemy.uc"
struct IISwatEnemy_GetNoDropWeaponChance_Parms
{
	  BITFIELD ReturnValue;
};
...
// "event"	function whose parameters correspond to	"struct IISwatEnemy_eventThreatTimerIsOver_Parms"	is declared	in "..\SwatAICommon\Classes\ISwatEnemy.uc"
struct IISwatEnemy_ThreatTimerIsOver_Parms
{
	  BITFIELD ReturnValue;
};
...
// "event"	function whose parameters correspond to	"struct IISwatOfficer_eventIsInFormation_Parms"	is declared	in "..\SwatAICommon\Classes\ISwatOfficer.uc"
struct IISwatOfficer_IsInFormation_Parms
{
	  BITFIELD ReturnValue;
};
...
// Constant ShieldOnChanceModifier is declared in "..\SwatAICommon\Classes\Actions\CommanderAction.uc"
#define UCONST_ShieldOnChanceModifier 0.3
// Constant FlashlightOnChanceModifier is declared in "..\SwatAICommon\Classes\Actions\CommanderAction.uc"
#define UCONST_FlashlightOnChanceModifier 0.2
...
public:
	  ...
	  void SwapInRestrainedFloorAnimSet()
	  {
		   ProcessEvent(FindFunctionChecked(SWATAICOMMON_SwapInRestrainedFloorAnimSet),NULL);
	  }
...
public:
	  ...
	  BITFIELD GetNoDropWeaponChance()
	  {
        IISwatEnemy_GetNoDropWeaponChance_Parms Parms;
		   Parms.ReturnValue=0;
        ProcessFunction(FindFunctionChecked(SWATAICOMMON_GetNoDropWeaponChance),&Parms);
		   return Parms.ReturnValue;
	  }
	  ...
	  BITFIELD ThreatTimerIsOver()
	  {
        IISwatEnemy_ThreatTimerIsOver_Parms Parms;
		   Parms.ReturnValue=0;
        ProcessFunction(FindFunctionChecked(SWATAICOMMON_ThreatTimerIsOver),&Parms);
		   return Parms.ReturnValue;
	  }
...
{
public:
	  BITFIELD IsInFormation()
	  {
        IISwatOfficer_IsInFormation_Parms Parms;
		   Parms.ReturnValue=0;
        ProcessFunction(FindFunctionChecked(SWATAICOMMON_IsInFormation),&Parms);
		   return Parms.ReturnValue;
	  }
	  void ClearFormation()
	  {
