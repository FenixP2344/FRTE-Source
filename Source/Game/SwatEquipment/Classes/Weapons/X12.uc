///////////////////////////////////////////////////////////////////////////////////
class X12 extends RoundBasedWeapon
...
simulated function TraceFireInternal(int cartridge)
{
    ...
    Level.GetLocalPlayerController().AddRecoil(RecoilBackDuration, RecoilForeDuration, RecoilMagnitude);
...
defaultproperties
{
    ...
    WireSlackTweenTime=0.5
    WireSlackStartSpeed=100
    WireMinYZScale=0.1
    WireMaxYZScale=1
    WireAnimRate=1
    WireMaxHeightFraction=0.12
    WireMaxHeight=15
