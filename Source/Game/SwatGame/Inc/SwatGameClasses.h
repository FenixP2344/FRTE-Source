...
// Enum LeanWalkState is declared in "..\SwatGame\Classes\SwatPlayer.uc"
enum LeanWalkState
{
	 Lean_Cent               =0,
	 Lean_Left               =1,
...
enum ECommand
{
	 ...
	 Command_Request_Wedge   =95,
	 Command_Request_Lightstick=96,
	 Command_Request_C2      =97,
	 Command_TrapsAndMirror  =98,
	 Command_Heal            =99,
	 Command_Heal_Me         =100,
	 Command_CheckCorner     =101,
	 Command_TryDoorPeek     =102,
	 Command_Ram             =103,
	 Command_RamAndClear     =104,
	 Command_RamBangAndClear =105,
	 Command_RamGasAndClear  =106,
	 Command_RamStingAndClear=107,
	 Command_RamLeaderThrowAndClear=108,
	 Command_RamAndMakeEntry =109,
	 Command_RamBangAndMakeEntry=110,
	 Command_RamGasAndMakeEntry=111,
	 Command_RamStingAndMakeEntry=112,
	 Command_RamLeaderThrowAndMakeEntry=113,
	 Command_Static          =114,
	 Command_MAX             =115,
};
...
enum eExtraInts
{
	 ...
	 ExtraInt_ManualLowReady =6,
	 ExtraInt_MinimalHud     =7,
	 ExtraInt_DisablePenalty =8,
	 ExtraInt_MAX            =9,
};
...
public:
    ...
    FLOAT QualifyTimeForToolkit;
    BITFIELD DoorCheckLockTrapped:1;
    FLOAT RamDamage;
    ...
    FStringNoInit DeployedWedgeClassName;
...
public:
    ...
    BITFIELD bDebugSensor:1;
	   ...
	   DECLARE_FUNCTION(execCanHit);
	   DECLARE_FUNCTION(execCanHitTargetAt);
	   DECLARE_FUNCTION(execGetAimOrigin);
...
public:
    ...
    INT Unused5;
    FRange Unused6;
    class UMaterial* SWATDefaultPants;
...
public:
    BITFIELD CaresAboutCanBeArrestedNow:1;
    BITFIELD CanBeArrestedNow:1;
    BITFIELD CaresAboutCanBeHealedNow:1;
    BITFIELD CanBeHealedNow:1;
...
public:
    ...
    BITFIELD IsReported:1;
    BITFIELD CaresAboutRestrainedOnFloor:1;
...
public:
    ...
    BITFIELD CaresAboutPartialOpen:1;
    BITFIELD IsOpen:1;
...
AUTOGENERATE_FUNCTION(ASwatAI,-1,execCanHit);
AUTOGENERATE_FUNCTION(ASwatAI,-1,execCanHitTargetAt);
AUTOGENERATE_FUNCTION(ASwatAI,-1,execGetAimOrigin);
