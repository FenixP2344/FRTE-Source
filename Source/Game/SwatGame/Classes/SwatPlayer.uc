...
simulated protected function bool CanPawnUseLowReady()
{
  ...
  if( Equipment.IsA('Optiwand') || Equipment.IsA('BatteringRam') || ((Equipment.GetSlot() != Slot_PrimaryWeapon) && (Equipment.GetSlot() != Slot_SecondaryWeapon) ) ) 
    return false;
...
simulated function leanr( float dTime )
{
                       ...
                       float MPPlayerProtectiveEquipmentDurationScaleFactor )
{
	...
	//added minimum effect duration , avoiding CS gas effect crash
