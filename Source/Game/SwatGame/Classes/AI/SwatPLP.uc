///////////////////////////////////////////////////////////////////////////////
// PLP Soilders can Investigate, attack, flee, regroup, barricade
// but not threaten hostages. SwatAICommon.OfficerCommanderAction
///////////////////////////////////////////////////////////////////////////////

class SwatPLP extends SwatEnemyExtend;
...
event bool IgnoresSeenPawnsOfType(class<Pawn> SeenType)
{
    ...
    return (ClassIsChildOf(SeenType, class'SwatGame.SwatPLP') ||
            ClassIsChildOf(SeenType, class'SwatGame.SwatWildGunner') ||
			ClassIsChildOf(SeenType, class'SwatGame.SwatPLPThreat') ||	
