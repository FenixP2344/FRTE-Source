///////////////////////////////////////////////////////////////////////////////
// This is an extension class for zombies,
// They cannot be arrested and are immune to the influence of any less lethal
// Forget about ROE, evidence secure and reporting,
// Because they are not humans, all of this is meaningless
///////////////////////////////////////////////////////////////////////////////

class SwatZombie extends SwatEnemy;
...
function float GetTimeToWaitBeforeFiring()
{
	...
	return Super.GetTimeToWaitBeforeFiring();
}
...
// And Zombie and Human Soiders can not be report   -Probe

simulated function name GetEffectEventForReportingToTOCWhenDead()           { return 'ReportedZombieDown'; }
simulated function name GetEffectEventForReportingToTOCWhenIncapacitated()  { return 'ReportedZombieDown'; }
simulated function name GetEffectEventForReportingToTOCWhenArrested()       { return 'ReportedZombieSecured'; }

// Subclasses should override these functions with class-specific response
// effect event names. Overridden from SwatAI
simulated function name GetEffectEventForReportResponseFromTOCWhenIncapacitated()      { return 'RepliedZombieDown'; }
simulated function name GetEffectEventForReportResponseFromTOCWhenNotIncapacitated()   { return 'RepliedZombieDown'; }
