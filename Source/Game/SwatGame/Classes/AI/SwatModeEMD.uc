...
// They will attack hostages and any enemies
// Authorized to use lethal force at any time
///////////////////////////////////////////////////////////////////////////////

class SwatModeEMD extends SwatEnemyExtend;

import enum EquipmentSlot from Engine.HandheldEquipment;
import enum Pocket from Engine.HandheldEquipment;

const            LowSkillMinTimeBeforeShooting = 0.2;
const            LowSkillMaxTimeBeforeShooting = 0.4;
const            MediumSkillMinTimeBeforeShooting = 0.2;
const            MediumSkillMaxTimeBeforeShooting = 0.4;
const            HighSkillMinTimeBeforeShooting = 0.2;
const            HighSkillMaxTimeBeforeShooting = 0.4;
...
protected function ConstructWeaponAI()
{
	...
	weaponResource.addAbility(new class'SwatAICommon.RegroupAction');
	weaponResource.addAbility(new class'SwatAICommon.EscapeAction');
	weaponResource.addAbility(new class'SwatAICommon.ThreatenHostageAction');
	weaponResource.addAbility(new class'SwatAICommon.FleeAction');
}
...
event bool IgnoresSeenPawnsOfType(class<Pawn> SeenType)
{
    ...
    return (ClassIsChildOf(SeenType, class'SwatGame.SwatEnemy') ||
            ...
            //They will execute the killing when they see the hostages  - Fenix
