///////////////////////////////////////////////////////////////////////////////
// PLPThreat Soilders can Investigate, attack, flee, regroup, barricade
// but not threaten hostages. SwatAICommon.OfficerCommanderAction
///////////////////////////////////////////////////////////////////////////////

class SwatEasyPLPThreat extends SwatEnemyExtend;
...
event bool IgnoresSeenPawnsOfType(class<Pawn> SeenType)
{
    ...
    return (ClassIsChildOf(SeenType, class'SwatGame.SwatEasyPLPThreat') ||
