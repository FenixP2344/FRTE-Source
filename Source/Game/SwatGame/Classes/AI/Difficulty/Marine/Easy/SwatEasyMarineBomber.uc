...
class SwatEasyMarineBomber extends SwatEnemyExtend;
...
event bool IgnoresSeenPawnsOfType(class<Pawn> SeenType)
{
    ...
    return (ClassIsChildOf(SeenType, class'SwatGame.SwatEasyMarine') ||
			...
			ClassIsChildOf(SeenType, class'SwatGame.SwatEasyMarineBomber') ||
