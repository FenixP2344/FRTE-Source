///////////////////////////////////////////////////////////////////////////////
// Marine Bomber can Investigate, attack, flee, regroup, barricade
// SwatAICommon.OfficerCommanderAction
///////////////////////////////////////////////////////////////////////////////

class SwatNormalMarineBomber extends SwatEnemyExtend;
...
event bool IgnoresSeenPawnsOfType(class<Pawn> SeenType)
{
    ...
    return (ClassIsChildOf(SeenType, class'SwatGame.SwatNormalMarine') ||
			...
			ClassIsChildOf(SeenType, class'SwatGame.SwatNormalMarineBomber') ||
