...
class SwatHardMarineBomber extends SwatEnemyExtend;
...
event bool IgnoresSeenPawnsOfType(class<Pawn> SeenType)
{
    ...
    return (ClassIsChildOf(SeenType, class'SwatGame.SwatHardMarine') ||
			...
			ClassIsChildOf(SeenType, class'SwatGame.SwatHardMarineBomber') ||
