...
// SEF additions
var config int CampaignPath;  // Which campaign path we're on (0 = SWAT 4 + TSS, 1 = Extra Missions, 2 = All Missions , 3 = FR type , 4 = Vanilla)
...
var config bool ClassicMode;  //The Vanilla GameMode
