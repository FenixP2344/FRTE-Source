...
enum DoorPosition
{
	 ...
	 DoorPosition_PartialOpenLeft=3,
	 DoorPosition_PartialOpenRight=4,
	 DoorPosition_MAX        =5,
};
...
// "event"	function whose parameters correspond to	"struct APawn_eventCanShootTarget_Parms"	is declared	in "..\Engine\Classes\Pawn.uc"
struct APawn_eventCanShootTarget_Parms
{
	  class AActor* Target;
	  BITFIELD ReturnValue;
};
// "event"	function whose parameters correspond to	"struct APawn_eventCanHitTarget_Parms"	is declared	in "..\Engine\Classes\Pawn.uc"
struct APawn_eventCanHitTarget_Parms
{
	  class AActor* Target;
	  BITFIELD ReturnValue;
};
...
public:
    ...
    BITFIELD bAbleToQuickReload:1;
    BITFIELD AIisQuickReloaded:1;
    INT DeathFired;
    FLOAT aimerror;
...
public:
    ...
    BITFIELD bNotifiedDeathListeners:1;
	  ...
	  BITFIELD	eventCanShootTarget(class AActor* Target)
	  {
        APawn_eventCanShootTarget_Parms Parms;
		   Parms.ReturnValue=0;
		   Parms.Target=Target;
        ProcessEvent(FindFunctionChecked(ENGINE_CanShootTarget),&Parms);
		   return Parms.ReturnValue;
	  }
	  BITFIELD	eventCanHitTarget(class AActor* Target)
	  {
        APawn_eventCanHitTarget_Parms Parms;
		   Parms.ReturnValue=0;
		   Parms.Target=Target;
        ProcessEvent(FindFunctionChecked(ENGINE_CanHitTarget),&Parms);
		   return Parms.ReturnValue;
	  }
